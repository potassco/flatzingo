...
def test_mzn():
    ...
    check("tests/mzn/int_eq_imp_1.mzn", [[f"a={a}", f"b={b}"] + (['var("r")'] if r else []) for a,b,r in itertools.product(range(-3,10), range(-5,6), [False, True]) if (r and a == b) or (not r)])
    ...
    check("tests/mzn/int_le_imp_1.mzn", [[f"a={a}", f"b={b}"] + (['var("r")'] if r else []) for a,b,r in itertools.product(range(-3,10), range(-5,6), [False, True]) if (r and a <= b) or (not r)])
    ...
    check("tests/mzn/int_lin_eq_imp_1.mzn", [[f"a={a}", f"b={b}"] + (['var("r")'] if r else []) for a,b,r in itertools.product(range(-3,10), range(-5,6), [False, True]) if (r and (3*a + 2*b) == 26) or (not r)], optstr=2)
    check("tests/mzn/int_lin_le_1.mzn", [[f"a={a}", f"b={b}"] for a,b in itertools.product(range(-3,10), range(-5,6)) if (3*a + 2*b) <= 26])
    check("tests/mzn/int_lin_le_reif_1.mzn", [[f"a={a}", f"b={b}"] + (['var("r")'] if r else []) for a,b,r in itertools.product(range(-3,10), range(-5,6), [False, True]) if (r and (3*a + 2*b) <= 26) or (not r and (3*a + 2*b) > 26)])
    check("tests/mzn/int_lin_le_imp_1.mzn", [[f"a={a}", f"b={b}"] + (['var("r")'] if r else []) for a,b,r in itertools.product(range(-3,10), range(-5,6), [False, True]) if (r and (3*a + 2*b) <= 26) or (not r)])
    check("tests/mzn/int_lin_ne_1.mzn", [[f"a={a}", f"b={b}"] for a,b in itertools.product(range(-3,10), range(-5,6)) if (3*a + 2*b) != 26])
    check("tests/mzn/int_lin_ne_reif_1.mzn", [[f"a={a}", f"b={b}"] + (['var("r")'] if r else []) for a,b,r in itertools.product(range(-3,10), range(-5,6), [False, True]) if (r and (3*a + 2*b) != 26) or (not r and (3*a + 2*b) == 26)])
    check("tests/mzn/int_lin_ne_imp_1.mzn", [[f"a={a}", f"b={b}"] + (['var("r")'] if r else []) for a,b,r in itertools.product(range(-3,10), range(-5,6), [False, True]) if (r and (3*a + 2*b) != 26) or (not r)])
    check("tests/mzn/int_lt_1.mzn", [[f"a={a}", f"b={b}"] for a,b in itertools.product(range(-3,10), range(-5,6)) if a < b])
    check("tests/mzn/int_lt_reif_1.mzn", [[f"a={a}", f"b={b}"] + (['var("r")'] if r else []) for a,b,r in itertools.product(range(-3,10), range(-5,6), [False, True]) if (r and a < b) or (not r and a >= b)])
    check("tests/mzn/int_lt_imp_1.mzn", [[f"a={a}", f"b={b}"] + (['var("r")'] if r else []) for a,b,r in itertools.product(range(-3,10), range(-5,6), [False, True]) if (r and a < b) or (not r)])
    ...
    check("tests/mzn/int_ne_reif_1.mzn", [[f"a={a}", f"b={b}"] + (['var("r")'] if r else []) for a,b,r in itertools.product(range(-3,10), range(-5,6), [False, True]) if (r and a != b) or (not r and a == b)])
